...
public class FeatureFlagEntryImpl extends ASTWrapperPsiElement implements FeatureFlagEntry {

  public FeatureFlagEntryImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public FeatureFlagValueReference getValueReference() {
    return findChildByClass(FeatureFlagValueReference.class);
  }
